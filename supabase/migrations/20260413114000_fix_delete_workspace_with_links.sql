...
begin
  ...
  -- cuando existen links donde este workspace participa como origen o destino.
  delete from public.workspace_links wl
  where wl.source_workspace_id = target_workspace_id
     or wl.target_workspace_id = target_workspace_id;
